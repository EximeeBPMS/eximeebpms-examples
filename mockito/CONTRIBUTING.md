...
* [File issues](https://github.com/EximeeBPMS/eximeebpms-examples/issues)
...
- `git clone https://github.com/EximeeBPMS/eximeebpms-examples.git`
- `cd eximeebpms-examples/mockito`
- `mvn clean package`
