 ...
 */
package org.eximeebpms.bpm.tutorial.multitenancy;
...
import org.eximeebpms.spin.json.SpinJsonNode;
...
public class ProcessIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
      ...
      .addAsLibraries(libs)
      // prepare as process application archive for EximeeBPMS
      .addAsResource("META-INF/processes.xml", "META-INF/processes.xml")
      // enable CDI
      .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml")
      // add process application classes
      .addPackages(false, "org.eximeebpms.bpm.tutorial.multitenancy")
