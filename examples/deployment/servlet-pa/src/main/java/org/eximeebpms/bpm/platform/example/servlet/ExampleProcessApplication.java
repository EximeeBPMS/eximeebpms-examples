 ...
 */
package org.eximeebpms.bpm.platform.example.servlet;
 ...
 *
 * <p>See also:
 * <a href="https://docs.eximeebpms.org/manual/latest/user-guide/process-applications/the-process-application-class">User Guide on the Servlet Process Application</a>
 * </p>
 *
