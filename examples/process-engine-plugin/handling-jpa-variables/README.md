...
Extend the `org.eximeebpms.bpm.engine.impl.variable.serializer.AbstractTypedValueSerializer` class:
...
The process engine plugin can be activated in the `eximeebpms.cfg.xml`:

``` xml
<property name="processEnginePlugins">
  <list>
    <bean class="org.eximeebpms.bpm.example.jpa.variables.serializer.JPAVariablesSerializerPlugin" />
  </list>
</property>
```
...
[2]: src/main/java/org/eximeebpms/bpm/example/jpa/variables/serializer
[3]: src/test/java/org/eximeebpms/bpm/example/test/JPAVariableTest.java
