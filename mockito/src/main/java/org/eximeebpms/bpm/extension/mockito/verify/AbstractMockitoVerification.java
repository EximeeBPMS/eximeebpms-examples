...
public abstract class AbstractMockitoVerification<M, P> implements MockitoVerification<P> {
   ...
   *          {@link org.eximeebpms.bpm.engine.delegate.JavaDelegate},
   *          {@link org.eximeebpms.bpm.engine.delegate.TaskListener} or
   *          {@link org.eximeebpms.bpm.engine.delegate.ExecutionListener}.
   * @param parameterType
   *          the parameter the main method (execute() or notify() expects, one
   *          of either
   *          {@link org.eximeebpms.bpm.engine.delegate.DelegateExecution} or
   *          {@link org.eximeebpms.bpm.engine.delegate.DelegateTask}.
   */
