...
You can run the JUnit test [ProcessUnitTest](src/test/java/${packageInPathFormat}/ProcessUnitTest.java) in your IDE or using:
...
Built and tested against EximeeBPMS version ${eximeebpms-version} on WildFly 27+ Application Server.
