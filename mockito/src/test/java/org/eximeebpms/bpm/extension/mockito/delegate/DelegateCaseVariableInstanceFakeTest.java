...
import org.eximeebpms.bpm.engine.variable.impl.value.AbstractTypedValue;
...
public class DelegateCaseVariableInstanceFakeTest {
  ...
  private final DelegateCaseVariableInstanceFake fake = EximeeBpmsMockito.delegateCaseVariableInstanceFake();

  private final DelegateCaseExecutionFake caseExecution = EximeeBpmsMockito.delegateCaseExecutionFake();
