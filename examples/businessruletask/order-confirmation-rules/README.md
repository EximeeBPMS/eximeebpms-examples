...
This is a sample for the [EximeeBPMS platform](https://eximeebpms.org) on [Java EE](http://www.oracle.com/technetwork/java/javaee/overview/index.html) demonstrating integration with [JBoss Drools](http://www.jboss.org/drools/).
...
1. Download the [EximeeBPMS platform](https://eximeebpms.org) for JBoss AS 7 **(tested on 7.2.0)** from [here](https://eximeebpms.org/download/).
1. Install it, start it with `start-eximeebpms.bat`
...
1. Copy the generated WAR artifact to the JBoss AS 7 deployment directory `<EXIMEEBPMS_HOME>/server/jboss-as-7.2.0.Final/standalone/deployments/`
