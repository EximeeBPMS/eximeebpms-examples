...
This example demonstrates how to use the [EximeeBPMS DMN engine] as library
...
[EximeeBPMS DMN engine]: https://docs.eximeebpms.org/manual/latest/user-guide/dmn-engine/
[Reference Guide]: https://docs.eximeebpms.org/manual/latest/reference/dmn/drg/
[User Guide]: https://docs.eximeebpms.org/manual/latest/user-guide/dmn-engine/testing/
[Dinner Decisions]: src/main/resources/org/eximeebpms/bpm/example/drg/dinnerDecisions.png
[Beverages Decision]: src/main/resources/org/eximeebpms/bpm/example/drg/beverages.png
[Dish Decision]: src/main/resources/org/eximeebpms/bpm/example/drg/dish.png
[dinnerDecisions.dmn]: src/main/resources/org/eximeebpms/bpm/example/drg/dinnerDecisions.dmn
[BeveragesDecider.java]: src/main/java/org/eximeebpms/bpm/example/drg/BeveragesDecider.java
[DrgDecisionTest.java]: src/test/java/org/eximeebpms/bpm/example/drg/DrgDecisionTest.java
