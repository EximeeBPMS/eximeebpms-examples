...
import org.eximeebpms.bpm.scenario.impl.util.Api;
import org.eximeebpms.bpm.scenario.impl.util.IdComparator;
import org.eximeebpms.bpm.scenario.impl.util.Log;
import org.eximeebpms.bpm.scenario.impl.waitstate.CallActivityExecutable;
import org.eximeebpms.bpm.scenario.run.ProcessRunner;
import org.eximeebpms.bpm.scenario.run.ProcessRunner.ExecutableRunner.StartingByKey;
import org.eximeebpms.bpm.scenario.run.ProcessRunner.ExecutableRunner.StartingByMessage;
import org.eximeebpms.bpm.scenario.run.ProcessRunner.ExecutableRunner.StartingByStarter;
import org.eximeebpms.bpm.scenario.run.ProcessRunner.StartableRunner;
import org.eximeebpms.bpm.scenario.run.ProcessStarter;
...
public class ProcessRunnerImpl extends AbstractRunner implements StartingByKey, StartingByMessage, StartableRunner, StartingByStarter, ProcessRunner {
  ...
  public StartingByKey fromBefore(String activityId) {
    Api.feature(RuntimeService.class.getName(), "createProcessInstanceByKey", String.class)
      .fail("Outdated EximeeBPMS version used will not allow to start process instances " +
  ...
  public void setExecuted() {
    boolean supportsCanceled = Api.feature(HistoricActivityInstance.class.getName(), "isCanceled")
      .warn("Outdated EximeeBPMS version used will not allow to use " +
