...
The WildFly extensions from EximeeBPMS allow you to manage Process Engines as JBoss Services. However, 
...
<beans xmlns="http://www.springframework.org/schema/beans"
  ...
  <bean class="org.eximeebpms.bpm.example.spring.wildfly.ProcessEngineClient">
