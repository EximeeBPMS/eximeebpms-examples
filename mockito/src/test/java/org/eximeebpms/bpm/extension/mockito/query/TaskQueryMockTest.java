...
//import org.eximeebpms.bpm.extension.mockito.QueryMocks1;
...
public class TaskQueryMockTest {
  ...
  public void should_mock_query_and_return_singleResult() {
    final TaskQuery taskQuery = EximeeBpmsMockito.mockTaskQuery(taskService).singleResult(singleResult);
  ...
  public void singleResult_for_activityName() {
    EximeeBpmsMockito.mockTaskQuery(taskService).singleResult(singleResult);
