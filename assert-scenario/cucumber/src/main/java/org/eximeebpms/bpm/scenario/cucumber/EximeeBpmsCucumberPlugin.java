package org.eximeebpms.bpm.scenario.cucumber;
 ...
 */
public class EximeeBpmsCucumberPlugin implements ConcurrentEventListener {

  protected static final Logger log = LoggerFactory.getLogger(EximeeBpmsCucumberPlugin.class.getPackage().getName());
  protected static final String configurationResource = "eximeebpms.cfg.xml";
  ...
  protected void finish(TestCaseFinished event) {
    ...
    if (deploymentId != null) {
      ...
      try {
        ...
        Class<?> reportGeneratorClass = Class.forName("org.eximeebpms.bpm.scenario.report.cucumber.EximeeBpmsCucumberPluginReportGenerator");
