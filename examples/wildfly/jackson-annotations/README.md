...
which is used by EximeeBPMS Spin. This leads to problems with the usage of variable serialization and the usage of Jackson annotations (like `@JsonIgnore` for example).
...
3. Deploy the created war on latest EximeeBPMS WildFly distribution
...
These version corresponds to the version which is used by EximeeBPMS Spin for de-/serialization.

See the [Camunda forum post](https://forum.camunda.org/t/camunda-json-marshalling-and-jsonignore/271/19)
and the [documentation](https://docs.eximeebpms.org/manual/latest/installation/full/jboss/manual/#problems-with-jackson-annotations) for more information.
