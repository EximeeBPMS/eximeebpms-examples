...
import org.eximeebpms.bpm.extension.mockito.function.NameForType;
import org.eximeebpms.bpm.extension.mockito.mock.FluentExecutionListenerMock;
import org.eximeebpms.bpm.extension.mockito.mock.FluentJavaDelegateMock;
import org.eximeebpms.bpm.extension.mockito.mock.FluentTaskListenerMock;
import org.eximeebpms.bpm.extension.mockito.process.CallActivityMock;
import org.eximeebpms.bpm.extension.mockito.query.ActivityStatisticsQueryMock;
...
import org.eximeebpms.bpm.extension.mockito.query.EventSubscriptionQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.ExecutionQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.ExternalTaskQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.FilterQueryMock;
...
import org.eximeebpms.bpm.extension.mockito.query.HistoricIncidentQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.HistoricJobLogQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.HistoricProcessInstanceQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.HistoricTaskInstanceQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.HistoricVariableInstanceQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.IncidentQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.JobDefinitionQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.JobQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.ProcessDefinitionQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.ProcessDefinitionStatisticsQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.ProcessInstanceQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.TaskQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.TenantQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.UserOperationLogQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.UserQueryMock;
import org.eximeebpms.bpm.extension.mockito.query.VariableInstanceQueryMock;
import org.eximeebpms.bpm.extension.mockito.service.RuntimeServiceFluentMock;
import org.eximeebpms.bpm.extension.mockito.verify.MockitoVerification;
...
import static org.eximeebpms.bpm.engine.task.IdentityLinkType.CANDIDATE;
import static org.eximeebpms.bpm.extension.mockito.function.NameForType.juelNameFor;

@SuppressWarnings("unused")
public enum EximeeBpmsMockito {
  ;
   ...
   * @see org.eximeebpms.bpm.extension.mockito.Expressions#registerInstance(String,
   * Object)
   */
   ...
   * @see org.eximeebpms.bpm.extension.mockito.Expressions#getRegistered(String)
   */
   ...
   * @see #verifyJavaDelegateMock(org.eximeebpms.bpm.extension.mockito.mock.FluentJavaDelegateMock)
   */
  ...
  /**
   * Registers mocks via
   * {@link org.eximeebpms.bpm.engine.test.mock.Mocks#register(String, Object)} for
  ...
  /**
   * Delegates to
   * {@link org.eximeebpms.bpm.engine.test.mock.Mocks#register(String, Object)}
   *
  ...
  /**
   * @see org.eximeebpms.bpm.engine.test.mock.Mocks#reset()
   */
