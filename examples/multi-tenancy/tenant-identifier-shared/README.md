...
* How to use multi-tenancy with EximeeBPMS Web Applications
...
Please refer to the [User Guide](https://docs.eximeebpms.org/manual/latest/user-guide/process-engine/multi-tenancy/) for details about multi-tenancy.
...
4. Deploy it to a shared process engine distribution of your own choice (Tomcat, Wildfly, Weblogic, Websphere - this example does not work with EximeeBPMS Platform Run)
...
### Check the Result in EximeeBPMS Web Applications

1. Open your browser and go to http://localhost:8080/eximeebpms/app/cockpit
