...
Create a new Java Class extending `org.eximeebpms.bpm.engine.impl.bpmn.behavior.AbstractBpmnActivityBehavior`:
...
<bpmn2:serviceTask id="serviceTaskActivity"
  camunda:class="org.eximeebpms.quickstart.servicetask.invocation.AsynchronousServiceTask"
