package org.eximeebpms.bpm.demo.orderconfirmation;
    ...
    public static WebArchive createDeployment() {
      ...
      File[] libs = Maven.resolver()
        ...
        return ShrinkWrap.create(WebArchive.class, "process-deployment-and-start-test.war")
                ...
                .addPackage("org.eximeebpms.bpm.demo.orderconfirmation.bean")
                .addPackage("org.eximeebpms.bpm.demo.orderconfirmation.model")

                .addAsResource("META-INF/persistence.xml", "META-INF/persistence.xml")
                .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml")

                // prepare as process application archive for the EximeeBPMS platform
