...
it with `@ProcessApplication`, so the EximeeBPMS Platform can pick it up and register the Process 
...
Additionally, you have to package the `eximeebpms-engine-spring-6` module as a maven compile time 
dependency like:
...
This will create an EximeeBPMS Platform WildFly distribution and execute the included Arquillian test.

3. Watch out for this console log:

```bash
INFO  [org.eximeebpms.bpm.example.spring.servlet.pa.SpringServletProcessApplication] (MSC service thread 1-5) Invoking @PostDeploy annotation in org.eximeebpms.bpm.example.spring.servlet.pa.SpringServletProcessApplication
Starting testResolveBean processdefinition
INFO  [org.eximeebpms.bpm.example.spring.servlet.pa.ExampleBean] (MSC service thread 1-5) org.eximeebpms.bpm.example.spring.servlet.pa.ExampleBean is currently invoked.
INFO  [org.eximeebpms.bpm.example.spring.servlet.pa.SpringServletProcessApplication] (MSC service thread 1-5) Starting testResolveBeanFromJobExecutor processdefinition
INFO  [org.eximeebpms.bpm.example.spring.servlet.pa.ExampleDelegateBean] (pool-10-thread-7) org.eximeebpms.bpm.example.spring.servlet.pa.ExampleDelegateBean is currently invoked.
...
INFO  [org.eximeebpms.bpm.example.spring.servlet.pa.SpringServletProcessApplication] (MSC service thread 1-1) Invoking @PreUndeploy annotation in org.eximeebpms.bpm.example.spring.servlet.pa.SpringServletProcessApplication
