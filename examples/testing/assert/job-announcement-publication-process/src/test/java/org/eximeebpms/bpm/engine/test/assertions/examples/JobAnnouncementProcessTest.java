 ...
 */
package org.eximeebpms.bpm.engine.test.assertions.examples;

import org.eximeebpms.bpm.engine.runtime.ProcessInstance;
import org.eximeebpms.bpm.engine.test.Deployment;
import org.eximeebpms.bpm.engine.test.ProcessEngineRule;
import org.eximeebpms.bpm.engine.test.assertions.examples.jobannouncement.JobAnnouncement;
import org.eximeebpms.bpm.engine.test.assertions.examples.jobannouncement.JobAnnouncementService;
...
import static org.eximeebpms.bpm.engine.test.assertions.bpmn.BpmnAwareTests.findId;
...
public class JobAnnouncementProcessTest {
  ...
  @Deployment(resources = {
    "eximeebpms-testing-job-announcement.bpmn",
    "eximeebpms-testing-job-announcement-publication.bpmn"
  })
  ...
  @Test
  @Deployment(resources = { "eximeebpms-testing-job-announcement.bpmn", "eximeebpms-testing-job-announcement-publication.bpmn" })
  ...
  private ProcessInstance startProcess() {
    return runtimeService().startProcessInstanceByKey(
      "eximeebpms-testing-job-announcement",
