...
Implement the `org.eximeebpms.bpm.engine.delegate.JavaDelegate` interface:
...
<bpmn2:serviceTask id="ServiceTask_1"
  camunda:class="org.eximeebpms.quickstart.servicetask.invocation.sync.SynchronousServiceTask"
...
[4]: src/test/java/org/eximeebpms/quickstart/servicetask/invocation/sync/TestSynchronousServiceTask.java
