package org.eximeebpms.bpm.scenario;

import org.eximeebpms.bpm.scenario.act.*;
import org.eximeebpms.bpm.scenario.run.Runnable;
...
public interface ProcessScenario extends Runnable {
   ...
   * implement it by means of an EximeeBPMS ExternalTask.
   *
   ...
   * it by means of an EximeeBPMS ExternalTask.
   *
   * @param activityId the activity id of the message intermediate
   ...
   * waitstate in case you implement it by means of an EximeeBPMS
   * ExternalTask.
   *
