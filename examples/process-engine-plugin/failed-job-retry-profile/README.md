...
Extend the `org.eximeebpms.bpm.engine.impl.cfg.AbstractProcessEnginePlugin` class:
...
Extend the `org.eximeebpms.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener` class:
...
<property name="processEnginePlugins">
  <list>
    <bean class="org.eximeebpms.bpm.example.FailedJobRetryProfilePlugin">
...
``` xml
<bpmn:serviceTask id="ServiceTask_1" name="Fetch data from the CRM system " camunda:class="org.eximeebpms.bpm.example.delegate.ServiceTaskOneDelegate">
...
[3]: src/test/java/org/eximeebpms/bpm/example/test/FailedJobRetryProfileTest.java
