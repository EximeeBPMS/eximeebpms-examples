# EximeeBPMS Process Application
A Process Application for [EximeeBPMS](https://docs.eximeebpms.org).

This project has been generated by the Maven archetype
[eximeebpms-archetype-servlet-war-demo-1.3.0](https://docs.eximeebpms.org/manual/latest/user-guide/process-applications/maven-archetypes/).
...
For an easy start you can download Apache Tomcat with a pre-installed EximeeBPMS
from our [Download Page](https://eximeebpms.org/download/).
