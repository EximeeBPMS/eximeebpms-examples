...
This quickstart demonstrates how to use the [Embedded Forms][5] feature. Embedded Forms are plain HTML5 documents which can be loaded from your app and rendered embedded inside the EximeeBPMS Tasklist:
...
Embedded Taskforms are referenced using the `camunda:formKey` property of a BPMN `<startEvent>` or a BPMN `<userTask>`:
...
3. Deploy the war file to an EximeeBPMS Platform distribution
...
[4]: src/main/webapp
[5]: https://docs.eximeebpms.org/manual/latest/user-guide/task-forms/#embedded-task-forms
