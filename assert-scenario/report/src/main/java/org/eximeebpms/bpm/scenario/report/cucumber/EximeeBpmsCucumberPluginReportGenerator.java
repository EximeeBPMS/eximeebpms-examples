package org.eximeebpms.bpm.scenario.report.cucumber;
 ...
 */
public class EximeeBpmsCucumberPluginReportGenerator {

  public EximeeBpmsCucumberPluginReportGenerator(TestCase testCase, String deploymentId) {
