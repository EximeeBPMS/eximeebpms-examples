package org.eximeebpms.bpm.scenario.impl.util;

import org.eximeebpms.bpm.engine.impl.calendar.DurationHelper;
import org.eximeebpms.bpm.engine.impl.util.ClockUtil;
import org.eximeebpms.bpm.scenario.impl.util.Log.Action;
...
public class Time {
  ...
  // ***
  // Necessary due to two possible engine bugs with repeatable timers:
