package org.eximeebpms.bpm.extension.mockito.process;
...
public class ProcessInstanceFake implements ProcessInstance {
  ...
  public String getProcessDefinitionKey() {
    // not tracked by this fake (added to the real Execution interface after this
    // library's original release) - configure a real key via a test-specific stub
    // if a test needs one.
    return null;
  }
