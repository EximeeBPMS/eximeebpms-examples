...
Extend the `org.eximeebpms.bpm.engine.impl.cfg.AbstractProcessEnginePlugin` abstract class:
...
Extend the `org.eximeebpms.bpm.engine.impl.bpmn.parser.AbstractBpmnParseListener` abstract class:
...
Implement the `org.eximeebpms.bpm.engine.delegate.ExecutionListener` interface:
...
The BPMN Parse Listener can be activated in the `eximeebpms.cfg.xml`:

``` xml
<!-- activate bpmn parse listener as process engine plugin -->
<property name="processEnginePlugins">
  <list>
    <bean class="org.eximeebpms.bpm.example.parselistener.ProgressLoggingSupportParseListenerPlugin" />
  </list>
</property>
```
...
``` xml
<bpmn2:serviceTask id="ServiceTask_1" camunda:class="org.eximeebpms.bpm.example.delegate.ServiceTaskOneDelegate" name="ServiceTask 1">
...
[3]: src/test/java/org/eximeebpms/bpm/example/test/BpmnParseListenerTest.java
...
Implement the `org.eximeebpms.bpm.engine.delegate.TaskListener` interface:
...
<property name="processEnginePlugins">
  <list>
    <bean class="org.eximeebpms.bpm.example.parselistener.InformAssigneeParseListenerPlugin" />
  </list>
</property>
```
...
[5]: src/test/java/org/eximeebpms/bpm/example/test/BpmnParseListenerOnUserTaskTest.java
